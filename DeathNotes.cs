    ...
    class DeathNotes : RustPlugin
    {
        ...
        class Attacker
        {
            ...
            public string TryGetName()
            {
                ...
                if (type == AttackerType.Helicopter)
                    return "Helicopter";
                if (type == AttackerType.Apc)
                    return "Bradley";
                if (type == AttackerType.Turret)
                    return "Auto Turret";
                if (type == AttackerType.ShotgunTrap)
                    return "Shotgun Trap";
            ...
            public AttackerType TryGetType()
            {
                ...
                if (entity.name.Contains("bradleyapc.prefab"))
                ...
                if (entity.name.Contains("guntrap.deployed"))
                    return AttackerType.ShotgunTrap;
        ...
        class DeathData
        {
            ...
            public DeathReason TryGetReason()
            {
                ...
                else if (attacker.type == AttackerType.ShotgunTrap)
                    return DeathReason.ShotgunTrap;
        ...
        void LoadConfig()
        {
            ...
            SetConfig("Messages", "Apc", new List<object> { "{victim} thought they stood a chance against a military grade {attacker}." });
			SetConfig("Messages", "Apc Sleeping", new List<object> { "{victim} was sleeping when he was shot to pieces by a {attacker}." });
            SetConfig("Messages", "ApcDeath", new List<object> { "The {victim} was taken down." });
            ...
            SetConfig("Messages", "ShotgunTrap", new List<object> { "A {attacker} defended its home against {victim}." });
            ...
            Messages = GetConfig(new Dictionary<string, object>
            {
                ...
                { "Apc", new List<object> { "{victim} thought they stood a chance against a military grade {attacker}." }},
				{ "Apc Sleeping", new List<object> { "{victim} was sleeping when he was shot to pieces by a {attacker}." }},
                { "ApcDeath", new List<object> { "The {victim} was taken down." }},
                ...
                { "ShotgunTrap", new List<object> { "A {attacker} defended its home against {victim}." }},
